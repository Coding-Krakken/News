...
async def filter_articles(
    ...
    geographies: Optional[str] = Query(
        None, description="Comma-separated list of geographies"
    ),
    ideologies: Optional[str] = Query(
        None, description="Comma-separated list of ideologies"
    ),
