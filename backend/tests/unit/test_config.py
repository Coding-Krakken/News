...
class TestProductionConfiguration:
    ...
    def test_production_checklist(self, monkeypatch):
        ...
        monkeypatch.setenv("ENVIRONMENT", "production")
        monkeypatch.setenv("MONGODB_URL", "mongodb+srv://user:pass@cluster.mongodb.net/prod")
        monkeypatch.setenv("SECRET_KEY", "very-secure-production-secret-key-generated-with-openssl")
        ...
        assert all(origin.startswith("https://") for origin in settings.get_cors_origins_list())
