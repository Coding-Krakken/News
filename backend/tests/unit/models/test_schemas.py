...
from app.models.schemas import Article, Story, Claim, FactLedger, CoverageStats
...
class TestClaimModel:
    ...
    def test_claim_default_lists(self):
        ...
        claim = Claim(
            text="Test claim", attribution="Source", article_url="https://example.com"
        )
...
class TestCoverageStatsModel:
    ...
    def test_coverage_stats_creation(self):
        ...
        stats = CoverageStats(total_articles=100, total_stories=20)
