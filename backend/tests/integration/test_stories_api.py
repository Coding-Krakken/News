...
class TestStoriesAPI:
    ...
    @pytest.mark.asyncio
    async def test_get_stories_with_data(self, client: AsyncClient, mock_db, sample_story_data):
    ...
    @pytest.mark.asyncio
    async def test_get_story_by_id(self, client: AsyncClient, mock_db, sample_story_data):
    ...
    @pytest.mark.asyncio
    async def test_get_story_articles(self, client: AsyncClient, mock_db, sample_story_data, sample_articles_list):
        ...
        response = await client.get(f"/api/stories/{sample_story_data['story_id']}/articles")
    ...
    @pytest.mark.asyncio
    async def test_get_story_coverage(self, client: AsyncClient, mock_db, sample_story_data, sample_articles_list):
