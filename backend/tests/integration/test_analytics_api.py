...
class TestAnalyticsAPI:
    ...
    @pytest.mark.asyncio
    async def test_get_stats_with_data(self, client: AsyncClient, mock_db, sample_articles_list, sample_story_data):
    ...
    @pytest.mark.asyncio
    async def test_get_facets_with_data(self, client: AsyncClient, mock_db, sample_articles_list):
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_by_sources(self, client: AsyncClient, mock_db, sample_articles_list):
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_by_categories(self, client: AsyncClient, mock_db, sample_articles_list):
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_by_geographies(self, client: AsyncClient, mock_db, sample_articles_list):
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_by_ideologies(self, client: AsyncClient, mock_db, sample_articles_list):
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_multiple_criteria(self, client: AsyncClient, mock_db, sample_articles_list):
        ...
        response = await client.get("/api/analytics/filter?categories=tech&geographies=US")
    ...
    @pytest.mark.asyncio
    async def test_filter_articles_with_pagination(self, client: AsyncClient, mock_db, sample_articles_list):
