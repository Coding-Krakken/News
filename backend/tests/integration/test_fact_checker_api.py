...
class TestFactCheckerAPI:
    ...
    @pytest.mark.asyncio
    async def test_generate_fact_ledger_story_not_found(
    ...
    @pytest.mark.asyncio
    async def test_generate_fact_ledger_success(
        ...
        with patch(
            "app.routes.fact_checker.fact_checker.generate_fact_ledger",
            ...
            response = await client.post(
                f"/api/fact-checker/{sample_story_data['story_id']}"
            )
