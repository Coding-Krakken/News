...
// Routes
router.post('/', authenticate, validate(createFilterValidation), filterController.create.bind(filterController));
router.get('/', authenticate, filterController.list.bind(filterController));
router.put('/:id', authenticate, validate(updateFilterValidation), filterController.update.bind(filterController));
router.delete('/:id', authenticate, filterController.delete.bind(filterController));
