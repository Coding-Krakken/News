...
export class FeedController {
  async getCustomFeed(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      const preferences = await preferenceRepository.findByUserId(req.user.userId);
      ...
      const feedConfig = {
        ...
        message: 'This endpoint would return personalized news based on your preferences',
      };
