  ...
  return (
    <div className="filters">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
        <h3>Filters</h3>
        {hasActiveFilters && (
          <button onClick={clearFilters} className="button button-secondary" style={{ padding: '6px 12px' }}>
            Clear All
          </button>
        )}
      </div>
      ...
      {facets.categories.length > 0 && (
        <div className="filter-section">
          <label>Categories ({selectedFilters.categories.length} selected)</label>
          <div className="checkbox-group">
      ...
      {facets.geographies.length > 0 && (
        <div className="filter-section">
          <label>Geography ({selectedFilters.geographies.length} selected)</label>
          <div className="checkbox-group">
